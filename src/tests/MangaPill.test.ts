...
describe('MangaPill Tests', () => {
    ...
    const source: Source = new MangaPill(cheerio)
     ...
     */
    const mangaId = '4270/tales-of-demons-and-gods'
    ...
    it('Testing Notifications', async () => {
        const updates = await wrapper.filterUpdatedManga(source, new Date('2021-02-01'), [mangaId])
